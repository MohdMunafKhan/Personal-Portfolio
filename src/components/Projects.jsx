    ...
    <section className="project" id='work'>
      <div className="container">
        ...
        <div className="row mx-auto p-4 mb-3 project-box">
          ...
          <div className="col-md-6 project-box-txt">
            <h3 className='text-center text-primary mb-3'>Pathshala Education Hub - Free Learning Resources Website</h3>
            <p className='text-center text-danger'><i>Tech Stack: React JS, HTML5, CSS3, Bootstrap 5 and React-Router</i></p>
        ...
        <div className="row mx-auto p-4 mb-3 project-box">
          ...
          <div className="col-md-6 project-box-txt">
            <h3 className='text-center text-primary mb-3'>GearUp Auto - Car Website</h3>
            <p className='text-center text-danger'><i>Tech Stack: HTML5, CSS3, Bootstrap 5 and JavaScript</i></p>
